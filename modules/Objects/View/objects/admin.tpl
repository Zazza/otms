<div class="button" style="width: 150px; margin-bottom: 10px; font-weight: bold">
<img border="0" style="vertical-align: middle;" alt="plus" src="{{ registry.uri }}img/plus-button.png" />
&nbsp;
<a href="{{ registry.uri }}objects/templates/add/" style="text-decoration: none">новый шаблон</a>
</div>
...
<td align="center" style="border: 1px solid #ccc">
    <a href="{{ registry.uri }}objects/templates/list/{{ part.id }}/"><img style="vertical-align: middle" src="{{ registry.uri }}img/document-tree.png" alt="" border="0" /></a>
</td>
