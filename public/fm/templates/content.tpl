...
<a onclick="moveFiles()" style="cursor: pointer; float: right"><img border="0" width="86" height="20" src="{{ url }}/img/buttons/_move.png" alt="Переместить" /></a>
</div>
...
<a onclick="createDir()" style="cursor: pointer; float: right"><img border="0" width="60" height="20" src="{{ url }}/img/buttons/_add.png" alt="Создать" /></a>
</div>
