...
<br />
4) вкладка &quot;Настройки&quot; — меню &quot;Шаблоны&quot;. Теперь нажимаем на иконку &quot;структура&quot; у нужного шаблона. На новой странице добавляем необходимые группы для объектов. Так сделанно, чтобы усложнить структуру объектов. Например, имеем шаблон &quot;клиенты&quot;, а в нём создадим группы &quot;клиенты хостинга&quot;, &quot;клиенты интернет&quot; и т.д. Важно, хотя бы одна группа внутри шаблона, быть обязательно должна!
<br />
Создаём объект:<br />
<br />
1) Переходим на вкладку &quot;объекты&quot;. Нажимаем &quot;выбрать&quot;. По-умолчанию, выводятся все созданные шаблоны. Раскрываем нужный шаблон, и на нужном разделе жмём &quot;+&quot;, чтобы добавить новый объект.
<br />
2) появляется форма добавления объекта с необходимыми полями. Заполняем их, нажимаем &quot;Добавить&quot;.
<br />
Объект создан.<br />
<br />
