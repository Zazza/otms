{% if args %}
<form method="post" action="{{ uri }}stat/{{ args0 }}/">
{% else %}
<form method="post" action="{{ uri }}stat/">
{% endif %}

<p style="margin-top: 10px"><b>Укажите диапазон просматриваемых дат (<a href="{{ uri }}stat/?clear">сбросить</a>):</b></p>
