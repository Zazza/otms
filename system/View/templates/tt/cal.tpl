...
<div class="blockbd" style="width: 300px; font-size: 11px">

<p><b>Задачи:</b></p>

<div style="margin-bottom: 10px">
<a style="cursor: pointer" href="{{ uri }}tt/task/allmy/">Всего моих задач:</a>
&nbsp;<b>[{{ allmytask }}]</b>
</div>

<span style="position: static; margin-left: 10px">
<a title="периодические" href="{{ uri }}tt/task/iter/"><img style="position: relative; top: 3px" src="{{ uri }}img/calendar-blue.png" alt="" border="0" /></a> <b>[{{ itertask }}]</b>
</span>

<span style="position: static; margin-left: 10px">
<a title="ограниченные по времени" href="{{ uri }}tt/task/time/"><img src="{{ uri }}img/alarm-clock.png" alt="" border="0" style="vertical-align: middle" /></a> <b>[{{ timetask }}]</b>
</span>

{% set noiter = allmytask - itertask - timetask %}
<span style="float: right; position: static; margin-right: 10px">
<a title="неограниченные по времени" href="{{ uri }}tt/task/noiter/"><img src="{{ uri }}img/clock.png" alt="" border="0" style="vertical-align: middle" /></a> <a href="{{ uri }}tt/task/noiter/">Глобальные</a> <b>[{{ noiter }}]</b>
</span>

<div style="margin-top: 10px">
<a style="cursor: pointer" href="{{ uri }}tt/task/me/">Созданных мною</a> <b>[{{ allmetask }}]</b></p>
</div>

<div style="margin-top: 10px">
<img src="{{ uri }}img/flag.png" alt="" /> - закрытые задачи
</div>

</div>

<table cellpadding="3" cellspacing="2" width="100%" style="padding-right: 50px">

<tr style="height: 30px">
<td width="14%" style="background-color: #AAC2D9; text-align: center"><b>Понедельник</b></td>
<td width="14%" style="background-color: #AAC2D9; text-align: center"><b>Вторник</b></td>
<td width="14%" style="background-color: #AAC2D9; text-align: center"><b>Среда</b></td>
<td width="14%" style="background-color: #AAC2D9; text-align: center"><b>Четверг</b></td>
<td width="14%" style="background-color: #AAC2D9; text-align: center"><b>Пятница</b></td>
<td width="14%" style="background-color: #D9A444; text-align: center"><b>Суббота</b></td>
<td width="14%" style="background-color: #D9A444; text-align: center"><b>Воскресенье</b></td>
</tr>
...
$(".caltd").click(function(e){
    $("#caldate").remove();
    
    if ($(".subtd", this).attr("title") > 0) {
        {% if ui.readonly == 1 %}
            var dialog = '<p style="margin-bottom: 10px"><b>' + $(".subtd", this).text() + "-" + $("#month").val() + "-" + $("#year").val() + '</b></p><p><img src="{{ uri }}img/edititem.gif" alt="" style="vertical-align: middle" />&nbsp;<a href="{{ uri }}tt/date/' + $(".subtd", this).attr("title") + '/">Перейти&nbsp;к&nbsp;этой&nbsp;дате</a></p>';
        {% else %}
            var dialog = '<p style="margin-bottom: 10px"><b>' + $(".subtd", this).text() + "-" + $("#month").val() + "-" + $("#year").val() + '</b></p><p style="margin-bottom: 5px"><img src="{{ uri }}img/plus-button.png" alt="" style="vertical-align: middle" />&nbsp;<a href="{{ uri }}tt/add/?date=' + $(".subtd", this).attr("title") + '">Создать&nbsp;задачу</a></p><p><img src="{{ uri }}img/edititem.gif" alt="" style="vertical-align: middle" />&nbsp;<a href="{{ uri }}tt/date/' + $(".subtd", this).attr("title") + '/">Перейти&nbsp;к&nbsp;этой&nbsp;дате</a></p>';
        {% endif %}

        $("body").append("<div id='caldate'>" + dialog + "</div>");
