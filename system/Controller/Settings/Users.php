            ...
            if ($this->registry["ui"]["admin"]) {
                ...
                if (isset($args[1])) {
                    ...
                    if ($args[1] == "adduser") {
                        ...
                        $this->view->settings_adduser(array("group" => $group, "post" => $post));
                        ...
                        if (isset($args[2])) {
                            ...
                            if(isset($_POST['submit'])) {
                                ...
                                if (count($err) == 0) {
                                    ...
                                    $uid = $this->user->editUser($args[2], $_POST["name"], $_POST["soname"], $_POST["email"], $notify, $_POST["time_notify"]);
                                    if ($data["pass"] != $_POST["pass"]) {
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        if (count($err) == 0) {
                            ...
                            $uid = $this->user->addUser($_POST["login"], $_POST["pass"], $_POST["name"], $_POST["soname"], $_POST["email"], $notify, $_POST["time_notify"]);
